...
function Login() {
  ...
  const handleLogin = (e) => {
    ...
    toast.promise(
      pageStatus == "LOGIN"
        ? AppServices.login({ login: email, password })
        : AppServices.verifyOTP({
            emailAddress: email,
        ...
        {pageStatus === "LOGIN" ? (
          <form className="text-center" onSubmit={handleLogin}>
            ...
            <div className="title mb-8">
              Welcome to <br />
              <div className="small">User Account Management System</div>
            </div>
            ...
            <div
              onClick={toggleModal}
              className="input-container  mb-2 text-primary cursor-pointer"
            >
            ...
            <div
              ...
              className="input-container  mb-3 text-primary cursor-pointer"
            >
              Forgot Password?
            </div>
            <div class="flex items-center gap-5 mb-4" data-testid="divider">
          ...
          <form className="text-center" onSubmit={handleLogin}>
            ...
            <div className="title mb-8">
              ...
              <div className="small"> which was sent to your email.</div>
            </div>
            <div className="input-container  mb-8">
              <input
                defaultValue={""}
                  ...
                  <div className="px-4 py-5 bg-white sm:p-6">
                    <div className="grid grid-cols-6 gap-6">
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        {/* TODO: fetch nationalities from world bank api */}
                        <select
