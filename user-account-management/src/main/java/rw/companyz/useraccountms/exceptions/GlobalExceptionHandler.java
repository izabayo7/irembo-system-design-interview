...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> badRequestAlertException(BadRequestException ex, Locale locale) {
        String errorMessage = (ex.getArgs() != null) ?
                messageSource.getMessage(ex.getMessage(), ex.getArgs(), locale) :
                ex.getMessage();
        return new ResponseEntity<>(new ApiResponse<>(errorMessage, Optional.empty(), HttpStatus.BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<?> tokenRefreshException(TokenRefreshException ex, Locale locale) {
        String errorMessage = messageSource.getMessage(ex.getMessage(), ex.getArgs(), locale);
        return new ApiResponse<>(errorMessage, (Object) "", HttpStatus.BAD_REQUEST).toResponseEntity();
    }
